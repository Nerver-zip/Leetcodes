<h2><a href="https://leetcode.com/problems/largest-integer-with-given-digit-sum/">4000. Largest Integer With Given Digit Sum</a></h2><h3>Easy</h3><hr><p>You are given two non-negative integers <code>n</code> and <code>s</code>.</p>
...
<hr><h3>Submission metrics</h3><ul><li><strong>Runtime measured by LeetCode:</strong> 0 ms</li><li><strong>Memory measured by LeetCode:</strong> 8.6 MB</li></ul><h3>Big-O analysis</h3><ul><li><strong>Time:</strong> Unknown</li><li><strong>Space:</strong> Unknown</li><li><strong>Source:</strong> unavailable (unknown confidence)</li></ul><p><em>Source code was not available for complexity analysis.</em></p>