...
public:
    int numSquares(int n) {
        // dp[s] = numero mínimo de quadrados perfeitos necessaários para formar soma s
...
private:
    static inline constexpr array<int, 100> nums = {
        ...
        7569,7744,7921,8100,8281,8464,8649,8836,9025,9216,9409,9604,9801,10000
    };
};